...
import { GetDefaultFieldNamesFn, fillLeafs } from 'graphiql/dist/utility/fillLeafs';
import { getLeft, getTop } from 'graphiql/dist/utility/elementPosition';
import mergeAST from 'graphiql/dist/utility/mergeAst';
import {
    introspectionQuery,
...
export class GraphiQL extends React.Component<GraphiQLProps, GraphiQLState> {
    ...
    resultComponent: Maybe<Component>;
        ...
        return (
            <div
                ...
                <div className="editorWrap">
                    ...
                    <div
                        ref={node => this.editorBarComponent = node}
                        className="editorBar"
                        onDoubleClick={this.handleResetResize}
                        onMouseDown={this.handleResizeStart}>
                        <div className="queryWrap" style={queryWrapStyle}>
                            <QueryEditor
                                ref={node => this.queryEditorComponent = node}
                                schema={this.state.schema}
                            ...
                            <section
                                ...
                                <VariableEditor
                                    ref={node => this.variableEditorComponent = node}
                                ...
                                {this.state.headerEditorEnabled && (
                                    <HeaderEditor
                                        ref={node => this.headerEditorComponent = node}
                ...
                {this.state.docExplorerOpen && (
                    <div className={docExplorerWrapClasses} style={docWrapStyle}>
                        ...
                        />
                        <DocExplorer
                            ref={node => this.docExplorerComponent = node}
                            schema={this.state.schema}>
                            <button
                                className="docExplorerHide"
                                onClick={this.handleToggleDocs}
